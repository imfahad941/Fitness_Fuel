...
public class ThirdActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (intvalue){
            ...
            case 1:
                setContentView(R.layout.mountain_climber2);
                break;

            case 2:
                setContentView(R.layout.basic_crunches2);
                break;

            case 3:
                setContentView(R.layout.bench_dips2);
                break;
            case 4:
                setContentView(R.layout.bicycle_crunches2);
                break;

            case 5:
                setContentView(R.layout.leg_raise2);
                break;

            case 6:
                setContentView(R.layout.alternative_heel_touch2);
                break;

            case 7:
                setContentView(R.layout.leg_up_crunches2);
                break;

            case 8:
                setContentView(R.layout.sit_ups2);
                break;

            case 9:
                setContentView(R.layout.alternative_v_ups2);
                break;

            case 10:
                setContentView(R.layout.plank_rotation2);
                break;

            case 11:
                setContentView(R.layout.plank_with_leg_left2);
                break;

            case 12:
                setContentView(R.layout.russian_twist2);
                break;
            ...
            case 14:
                setContentView(R.layout.vertica_leg_crunches2);
                break;
